...
--
-- Name: docs_server_processor; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.docs_server_processor (
    id bigint NOT NULL,
    uuid character varying(128) NOT NULL,
    function_name character varying(128) NOT NULL,
    display_name character varying(120) NOT NULL,
...
--
-- Name: docs_server_processor_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.docs_server_processor_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: docs_server_processor_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.docs_server_processor_id_seq OWNED BY public.docs_server_processor.id;
...
--
-- Name: docs_server_processor id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.docs_server_processor ALTER COLUMN id SET DEFAULT nextval('public.docs_server_processor_id_seq'::regclass);
...
--
-- Name: docs_server_processor docs_server_processor_function_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.docs_server_processor
    ADD CONSTRAINT docs_server_processor_function_name_unique UNIQUE (function_name);


--
-- Name: docs_server_processor docs_server_processor_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.docs_server_processor
    ADD CONSTRAINT docs_server_processor_pkey PRIMARY KEY (id);


--
-- Name: docs_server_processor docs_server_processor_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_docs_server_processor_category; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_docs_server_processor_category ON public.docs_server_processor USING btree (category);


--
-- Name: idx_docs_server_processor_source_kind; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_docs_server_processor_source_kind ON public.docs_server_processor USING btree (source_kind);
